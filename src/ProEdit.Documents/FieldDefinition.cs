...
public static class FieldInstructionParser
{
    ...
    private static FieldKind ParseKind(string name)
    {
        ...
        return name.ToUpperInvariant() switch
        {
            ...
            "ADDRESSBLOCK" => FieldKind.AddressBlock,
            "GREETINGLINE" => FieldKind.GreetingLine,
            "IF" => FieldKind.MergeRule,
            "NEXT" => FieldKind.MergeRule,
            "NEXTIF" => FieldKind.MergeRule,
            "SKIPIF" => FieldKind.MergeRule,
            "REF" => FieldKind.Ref,
