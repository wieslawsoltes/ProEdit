...
public partial class NotesPaneWindow : Window
{
    ...
    private void OnFootnoteSelectionChanged(object? sender, Avalonia.Controls.SelectionChangedEventArgs e)
    {
    ...
    private void OnEndnoteSelectionChanged(object? sender, Avalonia.Controls.SelectionChangedEventArgs e)
    {
        if (_suppressEditorChange)
        {
            return;
