...
internal sealed class UnoClipboardBridge : ICompatClipboardBridge
{
    ...
    private static byte[]? TryBuildOpenXml(Vibe.Office.Documents.Document document)
    {
        try
        {
    ...
    private static RichTextDocument ToCompatDocument(Vibe.Office.Documents.Document source)
    {
