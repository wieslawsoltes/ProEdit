...
internal static class CompatDocumentVisualFactory
{
    ...
    private static XamlDocs.Inline BuildInline(Vibe.Office.WinUICompat.Documents.Inline inline)
    {
        switch (inline)
        {
            case CompatRun run:
                return BuildRun(run);
            case Vibe.Office.WinUICompat.Documents.Bold bold:
                return BuildSpanLike(bold, new XamlDocs.Bold());
            case Vibe.Office.WinUICompat.Documents.Italic italic:
                return BuildSpanLike(italic, new XamlDocs.Italic());
            case Vibe.Office.WinUICompat.Documents.Underline underline:
            ...
            case Vibe.Office.WinUICompat.Documents.Figure figure:
                return BuildAnchoredInline(figure, "Figure");
            case Vibe.Office.WinUICompat.Documents.Floater floater:
                return BuildAnchoredInline(floater, "Floater");
            case Vibe.Office.WinUICompat.Documents.LineBreak:
    ...
    private static XamlDocs.Inline BuildAnchoredInline(Vibe.Office.WinUICompat.Documents.AnchoredBlock source, string label)
    {
        var placeholder = new XamlDocs.Run
        {
            Text = $"[{label}]"
    ...
    private static void ApplyTextStyles(Vibe.Office.WinUICompat.Documents.TextElement source, TextBlock target)
    {
    ...
    private static void ApplyTextStyles(Vibe.Office.WinUICompat.Documents.TextElement source, XamlDocs.TextElement target)
    {
        if (source.FontSize.HasValue)
        {
            target.FontSize = source.FontSize.Value;
    ...
    private static Microsoft.UI.Xaml.Thickness ToXamlThickness(Vibe.Office.WinUICompat.Documents.Thickness source)
    {
