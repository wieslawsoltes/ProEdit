...
public sealed class ReportService : IReportService
{
    ...
    private async ValueTask<ReportExecutionEnvironment> BuildExecutionEnvironmentAsync(
        ...
        CancellationToken cancellationToken)
    {
        var providerRegistry = requestEnvironment?.ProviderRegistry ?? Vibe.Office.Reporting.Data.ReportDataProviders.CreateDefaultRegistry();
        var hostDataRegistry = requestEnvironment?.HostDataRegistry ?? new Vibe.Office.Reporting.Data.ReportHostDataRegistry();
