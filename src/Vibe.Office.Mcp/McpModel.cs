...
/// <summary>
/// Well-known MCP protocol version constants used by the VibeOffice host.
/// </summary>
...
public sealed class McpImplementationInfo
{
    ...
    /// </summary>
    public string Name { get; set; } = "vibeoffice";
...
/// <summary>
/// Configures the VibeOffice MCP server surface.
/// </summary>
