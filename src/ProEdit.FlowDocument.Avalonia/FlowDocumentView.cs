...
using DocumentRenderOptions = ProEdit.Rendering.RenderOptions;
using ProEdit.Rendering.Skia;

namespace ProEdit.FlowDocument.Avalonia;

/// <summary>
/// Renders a FlowDocument using the ProEdit layout and rendering pipeline.
/// </summary>
public sealed class FlowDocumentView : Panel
{
    ...
    /// </summary>
    public static readonly StyledProperty<ProEdit.FlowDocument.FlowDocument?> FlowDocumentProperty =
        AvaloniaProperty.Register<FlowDocumentView, ProEdit.FlowDocument.FlowDocument?>(nameof(FlowDocument));
    ...
    /// </summary>
    public ProEdit.FlowDocument.FlowDocument? FlowDocument
    {
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            if (change.OldValue is ProEdit.FlowDocument.FlowDocument oldDocument)
            {
                oldDocument.Changed -= OnDocumentChanged;
            }

            if (change.NewValue is ProEdit.FlowDocument.FlowDocument newDocument)
            {
    ...
    private LayoutSettings CreateLayoutSettings(ProEdit.FlowDocument.FlowDocument flowDocument, Size size)
    {
