...
public sealed class DocxImporter
{
    ...
    public ProEditDocument Load(string filePath)
    {
    ...
    public ProEditDocument Load(Stream stream)
    {
    ...
    private ProEditDocument LoadDocument(WordprocessingDocument wordDocument)
    {
        ...
        ContentControlPlaceholderResolver? placeholderResolver)
    {
        ...
        ProEdit.Documents.TableCell ParseTableCell(DocumentFormat.OpenXml.Wordprocessing.TableCell cell)
        {
            var tableCell = new ProEdit.Documents.TableCell();
        ...
        ProEdit.Documents.TableCell? ParseTableCellElement(OpenXmlElement cellElement)
        {
        ...
        ProEdit.Documents.TableRow? ParseTableRowElement(OpenXmlElement rowElement)
        {
            ...
            var tableRow = new ProEdit.Documents.TableRow { ContentControl = rowContentControl };
        ...
        void AppendRow(ProEdit.Documents.TableRow tableRow)
        {
    ...
    private static void LoadDocumentSettings(MainDocumentPart? mainPart, ProEditDocument document)
    {
    ...
    private static void PopulateMailMergeData(ProEditDocument document)
    {
    ...
    private static void LoadDocumentProtectionSettings(Settings settings, ProEditDocument document)
    {
    ...
    private static void LoadDocumentEditingPreferenceSettings(Settings settings, ProEditDocument document)
    {
    ...
    private static void LoadDocumentTextLayoutSettings(Settings settings, ProEditDocument document)
    {
    ...
    private static void LoadCompatibilitySettings(Settings settings, ProEditDocument document)
    {
    ...
    private static void LoadDocumentBackground(MainDocumentPart? mainPart, ProEditDocument document)
    {
    ...
    private static void LoadDocumentProperties(WordprocessingDocument wordDocument, ProEditDocument document)
    {
    ...
    private static void LoadCustomXmlParts(MainDocumentPart? mainPart, ProEditDocument document)
    {
        if (mainPart is null)
        {
            return;
    ...
    private static void LoadFonts(MainDocumentPart? mainPart, ProEditDocument document)
    {
        if (mainPart is null)
        {
            return;
    ...
    private static ProEdit.Documents.SectionProperties ParseSectionProperties(DocumentFormat.OpenXml.Wordprocessing.SectionProperties sectionProps)
    {
        var properties = new ProEdit.Documents.SectionProperties();
        ...
        {
            var borders = new ProEdit.Documents.PageBorders
            {
    ...
    private static void ApplySectionProperties(ProEdit.Documents.SectionProperties target, ProEdit.Documents.SectionProperties source)
    {
    ...
    private sealed class StyleResolver
    {
        ...
        private readonly ProEditDocument _document;

        public DocumentThemeColorMap ThemeColors => _document.ThemeColors;

        public StyleResolver(MainDocumentPart? mainPart, ProEditDocument document)
        {
            _document = document;
        ...
        private void ApplyParagraphStyleChain(ProEdit.Documents.ParagraphProperties target, string styleId)
        {
    ...
    private sealed class ListResolver
    {
        ...
        public ListResolver(MainDocumentPart? mainPart, ProEditDocument document, StyleResolver styleResolver)
        {
            _document = document;
    ...
    private static void ApplyParagraphProperties(Paragraph paragraph, ProEdit.Documents.ParagraphProperties properties)
    {
        ApplyParagraphProperties(paragraph.ParagraphProperties, properties);
    }

    private static void ApplyParagraphProperties(OpenXmlElement? props, ProEdit.Documents.ParagraphProperties properties)
    {
        if (props is null)
        {
            return;
    ...
    private static void ApplyTableProperties(Table table, ProEdit.Documents.TableProperties properties, DocumentThemeColorMap? themeColors)
    {
    ...
    private static void ApplyTableProperties(OpenXmlElement? props, ProEdit.Documents.TableProperties properties, DocumentThemeColorMap? themeColors)
    {
        if (props is null)
        {
            return;
        ...
        if (tableAlignment is not null)
        {
            ...
            {
                properties.Alignment = ProEdit.Documents.TableAlignment.Center;
            }
            else if (tableAlignment == TableRowAlignmentValues.Right)
            {
                properties.Alignment = ProEdit.Documents.TableAlignment.Right;
            }
            else if (tableAlignment == TableRowAlignmentValues.Left)
            {
                properties.Alignment = ProEdit.Documents.TableAlignment.Left;
            }
        }
        ...
        if (tableLayout?.Type?.Value is TableLayoutValues layoutType)
        {
            properties.LayoutMode = layoutType == TableLayoutValues.Fixed
                ? ProEdit.Documents.TableLayoutMode.Fixed
                : ProEdit.Documents.TableLayoutMode.Auto;
        }
        ...
        if (look is not null)
        {
            ...
            properties.Look = new ProEdit.Documents.TableLook
            {
                FirstRow = firstRow,
                LastRow = lastRow,
    ...
    private static void ApplyTableWidth(TableWidth tableWidth, ProEdit.Documents.TableProperties properties)
    {
        var widthType = tableWidth.Type?.Value;
        if (widthType == TableWidthUnitValues.Auto)
        {
            properties.Width = null;
            properties.WidthUnit = ProEdit.Documents.TableWidthUnit.Auto;
            return;
        }
        ...
        if (widthType == TableWidthUnitValues.Dxa)
        {
            ...
            if (twips.HasValue)
            {
                ...
                properties.WidthUnit = ProEdit.Documents.TableWidthUnit.Dxa;
            }
        ...
        if (widthType == TableWidthUnitValues.Pct)
        {
            ...
            if (percent.HasValue)
            {
                ...
                properties.WidthUnit = ProEdit.Documents.TableWidthUnit.Pct;
            }
        }
    }

    private static void ApplyTableCellWidth(TableCellWidth cellWidth, ProEdit.Documents.TableCellProperties properties)
    {
        var widthType = cellWidth.Type?.Value;
        if (widthType == TableWidthUnitValues.Auto)
        {
            properties.PreferredWidth = null;
            properties.PreferredWidthUnit = ProEdit.Documents.TableWidthUnit.Auto;
            return;
        }
        ...
        if (widthType == TableWidthUnitValues.Pct)
        {
            ...
            if (percent.HasValue)
            {
                ...
                properties.PreferredWidthUnit = ProEdit.Documents.TableWidthUnit.Pct;
                return;
            }
        }
        ...
        if (widthTwips.HasValue)
        {
            ...
            properties.PreferredWidthUnit = ProEdit.Documents.TableWidthUnit.Dxa;
        }
    }

    private static void ApplyTableIndentation(TableIndentation indentation, ProEdit.Documents.TableProperties properties)
    {
        ...
        if (indentType == TableWidthUnitValues.Dxa)
        {
            ...
            if (twips.HasValue)
            {
                ...
                properties.IndentUnit = ProEdit.Documents.TableWidthUnit.Dxa;
            }
        ...
        if (indentType == TableWidthUnitValues.Pct)
        {
            ...
            if (percent.HasValue)
            {
                ...
                properties.IndentUnit = ProEdit.Documents.TableWidthUnit.Pct;
            }
        }
    }

    private static void ApplyTableCellSpacing(TableCellSpacing spacing, ProEdit.Documents.TableProperties properties)
    {
        ...
        if (spacingType == TableWidthUnitValues.Dxa)
        {
            ...
            if (twips.HasValue)
            {
                ...
                properties.CellSpacingUnit = ProEdit.Documents.TableWidthUnit.Dxa;
            }
        ...
        if (spacingType == TableWidthUnitValues.Pct)
        {
            ...
            if (percent.HasValue)
            {
                ...
                properties.CellSpacingUnit = ProEdit.Documents.TableWidthUnit.Pct;
            }
        }
    }

    private static void ApplyTableCellProperties(DocumentFormat.OpenXml.Wordprocessing.TableCell cell, ProEdit.Documents.TableCellProperties properties, DocumentThemeColorMap? themeColors)
    {
        ApplyTableCellProperties(cell.TableCellProperties, properties, themeColors);
    }

    private static void ApplyTableCellStructure(DocumentFormat.OpenXml.Wordprocessing.TableCell cell, ProEdit.Documents.TableCell target)
    {
    ...
    private static void ApplyTableRowProperties(DocumentFormat.OpenXml.Wordprocessing.TableRow row, ProEdit.Documents.TableRowProperties properties, DocumentThemeColorMap? themeColors)
    {
        ApplyTableRowProperties(row.TableRowProperties, properties, themeColors);
    }

    private static void ApplyTableRowProperties(OpenXmlElement? props, ProEdit.Documents.TableRowProperties properties, DocumentThemeColorMap? themeColors)
    {
        if (props is null)
        {
            return;
    ...
    private static void ApplyTableCellProperties(OpenXmlElement? props, ProEdit.Documents.TableCellProperties properties, DocumentThemeColorMap? themeColors)
    {
        if (props is null)
        {
            return;
        ...
        if (verticalAlignment is not null)
        {
            ...
            {
                properties.VerticalAlignment = ProEdit.Documents.TableCellVerticalAlignment.Center;
            }
            else if (verticalAlignment == TableVerticalAlignmentValues.Bottom)
            {
                properties.VerticalAlignment = ProEdit.Documents.TableCellVerticalAlignment.Bottom;
            }
            else
            {
                properties.VerticalAlignment = ProEdit.Documents.TableCellVerticalAlignment.Top;
            }
        }
    ...
    private static bool TryParseHighlightColor(HighlightColorValues value, out ProEdit.Primitives.DocColor color)
    {
        if (value == HighlightColorValues.Black)
        {
            color = new ProEdit.Primitives.DocColor(0, 0, 0);
            return true;
        }

        if (value == HighlightColorValues.Blue)
        {
            color = new ProEdit.Primitives.DocColor(0, 0, 255);
            return true;
        }

        if (value == HighlightColorValues.Cyan)
        {
            color = new ProEdit.Primitives.DocColor(0, 255, 255);
            return true;
        }

        if (value == HighlightColorValues.Green)
        {
            color = new ProEdit.Primitives.DocColor(0, 255, 0);
            return true;
        }

        if (value == HighlightColorValues.Magenta)
        {
            color = new ProEdit.Primitives.DocColor(255, 0, 255);
            return true;
        }

        if (value == HighlightColorValues.Red)
        {
            color = new ProEdit.Primitives.DocColor(255, 0, 0);
            return true;
        }

        if (value == HighlightColorValues.Yellow)
        {
            color = new ProEdit.Primitives.DocColor(255, 255, 0);
            return true;
        }

        if (value == HighlightColorValues.White)
        {
            color = new ProEdit.Primitives.DocColor(255, 255, 255);
            return true;
        }

        if (value == HighlightColorValues.DarkBlue)
        {
            color = new ProEdit.Primitives.DocColor(0, 0, 128);
            return true;
        }

        if (value == HighlightColorValues.DarkCyan)
        {
            color = new ProEdit.Primitives.DocColor(0, 128, 128);
            return true;
        }

        if (value == HighlightColorValues.DarkGreen)
        {
            color = new ProEdit.Primitives.DocColor(0, 128, 0);
            return true;
        }

        if (value == HighlightColorValues.DarkMagenta)
        {
            color = new ProEdit.Primitives.DocColor(128, 0, 128);
            return true;
        }

        if (value == HighlightColorValues.DarkRed)
        {
            color = new ProEdit.Primitives.DocColor(128, 0, 0);
            return true;
        }

        if (value == HighlightColorValues.DarkYellow)
        {
            color = new ProEdit.Primitives.DocColor(128, 128, 0);
            return true;
        }

        if (value == HighlightColorValues.LightGray)
        {
            color = new ProEdit.Primitives.DocColor(211, 211, 211);
            return true;
        }

        if (value == HighlightColorValues.DarkGray)
        {
            color = new ProEdit.Primitives.DocColor(169, 169, 169);
            return true;
        }
    ...
    private static ProEdit.Documents.FootnotePosition MapFootnotePosition(FootnotePositionValues value)
    {
        if (value == FootnotePositionValues.BeneathText)
        {
            return ProEdit.Documents.FootnotePosition.BeneathText;
        }

        return ProEdit.Documents.FootnotePosition.PageBottom;
    }

    private static ProEdit.Documents.EndnotePosition MapEndnotePosition(EndnotePositionValues value)
    {
        if (value == EndnotePositionValues.SectionEnd)
        {
            return ProEdit.Documents.EndnotePosition.EndOfSection;
        }

        return ProEdit.Documents.EndnotePosition.EndOfDocument;
    }
    ...
    private static FloatingAnchor BuildTableFloatingAnchor(
        ...
        ProEdit.Documents.TableAlignment? alignment)
    {
        ...
        FloatingHorizontalAlignment horizontalAlignment)
    {
        ...
        if (alignment == ProEdit.Documents.TableAlignment.Left)
        {
            return FloatingWrapSide.Right;
        }

        if (alignment == ProEdit.Documents.TableAlignment.Right)
        {
            return FloatingWrapSide.Left;
        }
    ...
    private static bool TryParseHexColor(string value, out ProEdit.Primitives.DocColor color)
    {
        ...
        color = new ProEdit.Primitives.DocColor(r, g, b);
        return true;
    }
    ...
    private static void LoadBibliography(MainDocumentPart? mainPart, ProEditDocument document)
    {
        if (mainPart is null)
        {
            return;
    ...
    private static bool TryLoadBibliographyPart(CustomXmlPart part, ProEditDocument document)
    {
        try
        {
            using var stream = part.GetStream(FileMode.Open, FileAccess.Read);
    ...
    private static void LoadMacros(MainDocumentPart? mainPart, ProEditDocument document)
    {
        if (mainPart is null)
        {
            return;
