...
using DocSectionProperties = ProEdit.Documents.SectionProperties;
...
public sealed class DocxExporter
{
    ...
    public void Save(ProEditDocument document, string filePath)
    {
        if (document is null)
        {
    ...
    public void Save(ProEditDocument document, Stream stream)
    {
        if (document is null)
        {
            throw new ArgumentNullException(nameof(document));
    ...
    private void SaveDocument(ProEditDocument document, WordprocessingDocument wordDocument)
    {
    ...
    private static void SaveMacros(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    private static void SaveBibliography(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    private static void SaveCustomXmlParts(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    private static NumberingContext EnsureNumbering(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    private sealed class ParagraphContextualSpacingResolver
    {
        ...
        public ParagraphContextualSpacingResolver(ProEditDocument document)
        {
        ...
        private static void ApplySpacing(ref ParagraphSpacingValues target, ProEdit.Documents.ParagraphProperties source)
        {
            if (source.SpacingBefore.HasValue)
            {
                target.SpacingBefore = source.SpacingBefore;
    ...
    private static IEnumerable<ListInfo> EnumerateListInfos(ProEditDocument document)
    {
    ...
    private static void EnsureStyles(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    private static void EnsureFontTable(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    private static void EnsureThemePart(MainDocumentPart mainPart, ProEditDocument document)
    {
    ...
    {
        var theme = new A.Theme { Name = "ProEdit Theme" };
    ...
    {
        var scheme = new A.ColorScheme { Name = "ProEdit Colors" };
    ...
    private static void EnsureDocumentSettings(MainDocumentPart mainPart, ProEditDocument document, bool includeEvenHeaders)
    {
    ...
    private static bool ShouldWriteMailMergeSettings(ProEditDocument document)
    {
    ...
    private static void ApplyDocumentBackground(DocumentFormat.OpenXml.Wordprocessing.Document documentXml, ProEditDocument document)
    {
    ...
    private static DocDefaults? BuildDocDefaults(ProEditDocument document, DocumentFonts fonts)
    {
    ...
    private static StyleTableProperties? BuildStyleTableProperties(ProEdit.Documents.TableProperties properties)
    {
    ...
    private static StyleTableCellProperties? BuildStyleTableCellProperties(ProEdit.Documents.TableCellProperties properties)
    {
        ...
        if (properties.VerticalAlignment.HasValue && properties.VerticalAlignment != ProEdit.Documents.TableCellVerticalAlignment.Top)
        {
            props.TableCellVerticalAlignment = new DocumentFormat.OpenXml.Wordprocessing.TableCellVerticalAlignment
            {
                ...
                {
                    ProEdit.Documents.TableCellVerticalAlignment.Center => TableVerticalAlignmentValues.Center,
                    ProEdit.Documents.TableCellVerticalAlignment.Bottom => TableVerticalAlignmentValues.Bottom,
    ...
    private static TableStyleConditionalFormattingTableProperties? BuildConditionalTableProperties(ProEdit.Documents.TableProperties properties)
    {
        if (!HasTableProperties(properties))
        {
            return null;
    ...
    private static TableStyleConditionalFormattingTableCellProperties? BuildConditionalTableCellProperties(ProEdit.Documents.TableCellProperties properties)
    {
        if (!HasTableCellProperties(properties))
        {
            return null;
    ...
    private static string? ResolveParagraphStyleId(ProEditDocument document, ParagraphBlock paragraph)
    {
        return paragraph.StyleId ?? document.Styles.DefaultParagraphStyleId;
    }

    private static bool IsSameParagraphStyle(ProEditDocument document, ParagraphBlock current, ParagraphBlock other)
    {
    ...
    private static DocumentFormat.OpenXml.Wordprocessing.TableRowProperties? BuildTableRowProperties(ProEdit.Documents.TableRow row)
    {
    ...
    private static DocumentFormat.OpenXml.Wordprocessing.SectionProperties BuildSectionProperties(
        ...
        ProEdit.Documents.SectionProperties? overrides = null)
    {
    ...
    private static bool ShouldWriteCommentsEx(ProEditDocument document)
    {
        foreach (var comment in document.Comments.Values)
        {
    ...
    private static Dictionary<int, string> BuildCommentParaIdMap(ProEditDocument document)
    {
    ...
    private static bool TryMapHighlightColor(ProEdit.Primitives.DocColor color, out HighlightColorValues highlight)
    {
    ...
    private static void AppendHighlightOrShading(OpenXmlCompositeElement props, ProEdit.Primitives.DocColor color)
    {
    ...
    private static FootnotePositionValues MapFootnotePosition(ProEdit.Documents.FootnotePosition position)
    {
        return position == ProEdit.Documents.FootnotePosition.BeneathText
            ? FootnotePositionValues.BeneathText
            : FootnotePositionValues.PageBottom;
    }

    private static EndnotePositionValues MapEndnotePosition(ProEdit.Documents.EndnotePosition position)
    {
        return position == ProEdit.Documents.EndnotePosition.EndOfSection
    ...
    private static string ColorToHex(ProEdit.Primitives.DocColor color)
    {
    ...
    {
        Color? element = null;
        if (color.HasValue && (!skipDefaultBlack || !color.Value.Equals(ProEdit.Primitives.DocColor.Black)))
        {
    ...
    private static void ApplySectionProperties(DocumentFormat.OpenXml.Wordprocessing.SectionProperties target, ProEdit.Documents.SectionProperties properties)
    {
        if (properties.PageWidth.HasValue || properties.PageHeight.HasValue || properties.Orientation.HasValue)
        {
            ...
            {
                pageSize.Orient = properties.Orientation == ProEdit.Documents.PageOrientation.Landscape
    ...
    private static DocumentFormat.OpenXml.Wordprocessing.TableProperties? BuildTableProperties(ProEdit.Documents.TableProperties properties, string? styleId)
    {
    ...
    private static void ApplyTableCellProperties(DocumentFormat.OpenXml.Wordprocessing.TableCell cell, ProEdit.Documents.TableCellProperties properties)
    {
    ...
    private static void ApplyTableCellStructure(DocumentFormat.OpenXml.Wordprocessing.TableCell cell, ProEdit.Documents.TableCell source)
    {
    ...
    private static bool HasTableProperties(ProEdit.Documents.TableProperties properties)
    {
    ...
    private static bool HasTableCellProperties(ProEdit.Documents.TableCellProperties properties)
    {
    ...
    private static bool HasTableBorders(ProEdit.Documents.TableBorders borders)
    {
    ...
    private static bool HasTableCellBorders(ProEdit.Documents.TableCellBorders borders)
    {
        return borders.Top is not null
               || borders.Bottom is not null
               || borders.Left is not null
    ...
    private static bool HasParagraphBorders(ProEdit.Documents.ParagraphBorders borders)
    {
        return borders.Top is not null
               || borders.Bottom is not null
               || borders.Left is not null
    ...
    private static OpenXmlParagraphBorders? BuildParagraphBorders(ProEdit.Documents.ParagraphBorders borders)
    {
    ...
    private static OpenXmlTableBorders? BuildTableBorders(ProEdit.Documents.TableBorders borders)
    {
    ...
    private static OpenXmlTableCellBorders? BuildTableCellBorders(ProEdit.Documents.TableCellBorders borders)
    {
    ...
    private sealed class ContentControlPlaceholderWriter
    {
        ...
        public string RegisterPlaceholder(string? name, string text)
        {
            ...
            do
            {
                generated = $"ProEditPlaceholder{_nextId++}";
            }
