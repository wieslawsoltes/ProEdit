...
namespace ProEdit.Reporting.Materialization;
...
public sealed class ReportMaterializer : IReportMaterializer
{
    ...
    private static ChartStyle CreateChartColorStyle(ChartType chartType, ProEdit.Primitives.DocColor color)
    {
    ...
    private static bool TryParseColor(
        string? value,
        out ProEdit.Primitives.DocColor color)
    {
        color = default;
        ...
        {
            color = ProEdit.Primitives.DocColor.FromArgb(a, r, g, b);
            return true;
        }
