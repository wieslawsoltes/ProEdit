...
public static class CollabPersistedFormat
{
    ...
    public const string SnapshotExtension = ".proedit.snapshot";
    public const string SnapshotIndexExtension = ".proedit.snapshot.idx";
    public const string OpLogExtension = ".proedit.ops";
    public const string PresenceExtension = ".proedit.presence";
