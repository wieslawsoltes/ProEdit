...
/// <summary>
/// Default <see cref="IXpsBridge"/> implementation that delegates XPS/OXPS conversion to Ghostscript.
/// </summary>
public sealed class GhostscriptXpsBridge : IXpsBridge
{
    ...
    public GhostscriptXpsBridge(XpsConversionOptions options)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var device = ResolveOutputDevice(flavor);
    ...
    private async Task ExecuteGhostscriptAsync(IReadOnlyList<string> arguments, CancellationToken cancellationToken)
    {
        ...
        throw new InvalidOperationException(
            $"Ghostscript executable was not found. Install Ghostscript or set '{nameof(XpsConversionOptions.GhostscriptPath)}'. Tried: {candidateList}.",
    ...
    private static string ResolveOutputDevice(XpsFlavor flavor)
    {
        // Ghostscript exposes xpswrite broadly; use it for both flavors.
        // OXPS extension remains supported at API level and file naming level.
        _ = flavor;
        return "xpswrite";
    }
