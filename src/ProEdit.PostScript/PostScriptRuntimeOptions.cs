...
public static class PostScriptRuntimeOptions
{
    ...
    /// </summary>
    public const string GhostscriptPathVariable = "PROEDIT_POSTSCRIPT_GHOSTSCRIPT_PATH";

    /// <summary>
    /// Environment variable used to override Ghostscript timeout in seconds.
    /// </summary>
    public const string ProcessTimeoutSecondsVariable = "PROEDIT_POSTSCRIPT_TIMEOUT_SECONDS";
