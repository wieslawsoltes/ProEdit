...
{
    /// <summary>
    /// Current schema version for native ProEdit report templates.
    /// </summary>
...
public sealed class ReportSharedTemplateDefinition
{
    ...
    /// </summary>
    public ReportDocumentTemplateFormat Format { get; set; } = ReportDocumentTemplateFormat.ProEdit;
...
{
    /// <summary>
    /// Native ProEdit document fragment.
    /// </summary>
    ProEdit,
