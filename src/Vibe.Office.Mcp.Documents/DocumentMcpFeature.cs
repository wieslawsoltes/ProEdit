...
namespace Vibe.Office.Mcp.Documents;
...
public sealed class DocumentMcpFeature : IMcpFeature
{
    ...
    private static bool TryParseDocumentUri(string uri, out string documentId, out string kind)
    {
        ...
        kind = string.Empty;
        const string prefix = "vibe://documents/";
    ...
    private static string GetSummaryUri(string documentId) => $"vibe://documents/{Uri.EscapeDataString(documentId)}/summary";

    private static string GetCustomXmlUri(string documentId) => $"vibe://documents/{Uri.EscapeDataString(documentId)}/custom-xml";

    private static string GetMailMergeUri(string documentId) => $"vibe://documents/{Uri.EscapeDataString(documentId)}/mail-merge";
