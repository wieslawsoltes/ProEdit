...
public sealed partial class ReportDesignerViewModel : ReactiveObject, IDisposable
{
    ...
    private bool ShouldPreserveDataWorkspaceSelection(object? selectionTarget)
    {
        ...
        return selectionTarget switch
        {
            ...
            ReportItem => true,
            ReportSection => true,
            ProEdit.Reporting.ReportDefinition => true,
            _ => false
        };
    }
    ...
    private void BuildPropertyEntries()
    {
        ...
        switch (_selectedTarget)
        {
            ...
            case ReportSharedTemplateDefinition template:
                ...
                AddTextProperty("template.content", "Content", "Embedded markdown, HTML, DOCX marker, or ProEdit fragment.", template.Content ?? string.Empty, true, value =>
                {
    ...
    private void BuildItemPropertyEntries(ReportItem item)
    {
        ...
        switch (item)
        {
            ...
            case DocumentTemplateItem templateItem:
                ...
                AddTextProperty("documentTemplate.embeddedContent", "Embedded Content", "Inline markdown, HTML, DOCX marker, or ProEdit fragment.", templateItem.EmbeddedContent ?? string.Empty, true, value =>
                {
