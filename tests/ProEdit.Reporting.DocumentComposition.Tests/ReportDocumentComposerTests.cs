...
namespace ProEdit.Reporting.DocumentComposition.Tests;
...
public sealed class ReportDocumentComposerTests
{
                ...
                new MaterializedReportSection
                {
                    ...
                    BodyItems =
                    {
                        new MaterializedDocumentTemplateReportItem
                        {
                            ...
                            TemplateFormat = ReportDocumentTemplateFormat.ProEdit,
                            Content = "Hello {{Name}}",
                            Bindings =
                            {
                                ["Name"] = "Contoso"
    ...
    public async Task ComposeAsync_AppliesRichStylesZOrderAndTablixPageBreaks()
    {
        ...
        Assert.Equal(new ProEdit.Primitives.DocThickness(8f, 6f, 4f, 2f), textShape.TextBox!.Properties.Padding);
        ...
        Assert.Equal(new ProEdit.Primitives.DocThickness(10f, 6f, 4f, 2f), tableBlocks[0].Rows[1].Cells[0].Properties.Padding!.Value);
