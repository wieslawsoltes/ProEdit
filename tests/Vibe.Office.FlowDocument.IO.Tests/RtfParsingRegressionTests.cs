...
public sealed class RtfParsingRegressionTests
{
    ...
    public void ParseRtf_ColorTableWithoutDefault_FirstBlackColorIsPreserved()
    {
        ...
        Assert.Equal(new Vibe.Office.Primitives.DocColor(0, 0, 0), run.Style.Color!.Value);
    }
    ...
    private static string ExtractText(Vibe.Office.FlowDocument.FlowDocument document)
    {
        var builder = new StringBuilder();
    ...
    private static void AppendBlockText(Vibe.Office.FlowDocument.Block block, StringBuilder builder)
    {
        switch (block)
        {
    ...
    private static void AppendInlineText(Vibe.Office.FlowDocument.Inline inline, StringBuilder builder)
    {
        switch (inline)
        {
            case Vibe.Office.FlowDocument.Run run:
                builder.Append(run.Text);
                break;
            case Vibe.Office.FlowDocument.Span span:
                ...
                break;
            case Vibe.Office.FlowDocument.LineBreak:
                builder.AppendLine();
                break;
        }
    }
