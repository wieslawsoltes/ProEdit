...
using Vibe.Office.RichText.Avalonia.Collaboration;
using Xunit;
...
public sealed class RichTextBoxCollaborationBehaviorTests
{
    ...
    public void Behavior_RejectsExternalFlowMutation_WhenCollaborationActive()
    {
        ...
        {
            box.Document.Blocks.Add(new Vibe.Office.FlowDocument.Paragraph("External"));
        });
    ...
    public async Task Behavior_AllowsReloadScenario_AfterMutationConflict()
    {
        ...
        {
            box.Document.Blocks[0] = new Vibe.Office.FlowDocument.Paragraph("Conflict");
        });
    ...
    private static Vibe.Office.FlowDocument.FlowDocument BuildFlowDocument(string text)
    {
        var document = new Vibe.Office.FlowDocument.FlowDocument();
        document.Blocks.Add(new Vibe.Office.FlowDocument.Paragraph(text));
        return document;
    }
