...
public sealed class DocxTrackChangesTests
{
    ...
    public void RoundTrip_PreservesTrackChangeMarkup()
    {
        ...
        try
        {
            ...
            Assert.Contains(document.Revisions.Timeline, revision => revision.Kind == Vibe.Office.Documents.RevisionKind.Insert && revision.Id == 1);
            Assert.Contains(document.Revisions.Timeline, revision => revision.Kind == Vibe.Office.Documents.RevisionKind.Delete && revision.Id == 2);
            Assert.Contains(document.Revisions.Timeline, revision => revision.Kind == Vibe.Office.Documents.RevisionKind.MoveFrom && revision.Id == 3);
            Assert.Contains(document.Revisions.Timeline, revision => revision.Kind == Vibe.Office.Documents.RevisionKind.MoveTo && revision.Id == 4);
